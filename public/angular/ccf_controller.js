 ...
 */
 //管理专利列表
 cjsApp.controller("adminCCFLevel",['$scope','$http','pageData','getItemService',
    ...
    // console.log('debug');
        ...
        //删除用户
        initDelOption($scope,$http,'您确认要删除选中的论文级别吗？');
        $('#addNewCCFLevel').modal({dimmer:0,closeViaDimmer: 0, width: 800});
        $('#addNewCCFLevel').modal('toggle');
        $('#addNewCCFLevel').on('open.modal.amui', function (event) {
            console.log("弹出框");
