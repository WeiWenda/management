 ...
 */
 //管理专利列表
 cjsApp.controller("adminProjectLevel",['$scope','$http','pageData','getItemService',
    ...
    // console.log('debug');
        ...
        //删除用户
        initDelOption($scope,$http,'您确认要删除选中的项目级别吗？');
        $('#addNewProjectLevel').modal({dimmer:0,closeViaDimmer: 0, width: 800});
        $('#addNewProjectLevel').modal('toggle');
        $('#addNewProjectLevel').on('open.modal.amui', function (event) {
            console.log("弹出框");
